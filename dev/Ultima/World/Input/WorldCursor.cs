...
namespace UltimaXNA.Ultima.World.Input
{
    ...
    class WorldCursor : UltimaCursor
    {
        ...
        private Mobile m_MouseOverMobile;
        private int m_MouseOverMobileSavedHue;
        ...
        public Mobile MouseOverMobile
        {
            get
            {
                return m_MouseOverMobile;
            }
            protected set
            {
                if (m_MouseOverMobile == value)
                    return;

                if (m_MouseOverMobile != null)
                {
                    m_MouseOverMobile.Hue = m_MouseOverMobileSavedHue;
                    m_MouseOverMobile.Highlight = false;

                }
                if (value == null)
                {
                    m_MouseOverMobile = null;
                    m_MouseOverItemSavedHue = 0;
                }
                else
                {
                    m_MouseOverMobile = value;
                    m_MouseOverMobileSavedHue = m_MouseOverMobile.Hue;
                    m_MouseOverMobile.Highlight = true;
                    m_MouseOverMobile.Hue = m_MouseOverMobile.NotorietyHue;
                }
            }
        }
        ...
        public override void Update()
        {
            ...
            if (MouseOverMobile == null && m_World.Input.MousePick.MouseOverObject is Mobile)
            {
                if (!m_World.Input.MousePick.MouseOverObject.IsClientEntity && player.Flags.IsWarMode)
                {
                    MouseOverMobile = m_World.Input.MousePick.MouseOverObject as Mobile;
                }
            }
